...
namespace CoreAndFood.Controllers
{
    ...
    public class ChartController : Controller
    {
        ...
        public IActionResult Statistics()
        {
            ...
            ViewBag.d3 = deger3;
            var deger4 = c.Foods.Where(x => x.CategoryID == c.Categories.Where( z => z.CategoryName == "Vegatables").Select(y =>
            ...
            var foodid = c.Categories.Where(x => x.CategoryName == "Animal Food").Select(y =>
               y.CategoryID).FirstOrDefault();
            var deger12 = c.Foods.Where(x => x.CategoryID == foodid).Count();
            ViewBag.d12 = deger12;
            return View();
        }
    }
